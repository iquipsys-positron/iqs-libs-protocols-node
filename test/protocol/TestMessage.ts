import { IStreamable } from '../../src/streams/IStreamable';
import { IStream } from '../../src/streams/IStream';

export class TestMessage implements IStreamable {
    ...
    public stream(stream: IStream): void {
        ...
        this.value8 = stream.streamQWord(this.value8);
        this.value9 = stream.streamLong(this.value9);
    }
